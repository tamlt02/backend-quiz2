...
function findStartEndOfMonth(input, timezone) {
    ...
    // set the moment to 28-31 23:59:59.999 this year
    let lastDay = moment.tz(moment(date).endOf('month'), timezone).format();
...
console.log(findStartEndOfMonth('2022-10-25T00:00:00.000', 'Amerca/Asuncion'))